# OD Demand is distributed by creating a virtual "Centroid" node for each zone and connecting it to all physical nodes in that zone with high-capacity, low-travel-time links
...
df_baseline.to_csv('Setup 2 Baseline Network Flows.csv', index=False)
print("Saved baseline flows to 'Setup 2 Baseline Network Flows.csv'")
...
# Save to CSV
df_results.to_csv('Setup 2 Results.csv', index=False)
print("\nData successfully saved to 'Setup 2 Results.csv'")
