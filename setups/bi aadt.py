...
#     # Check for, save, and remove REVERSE edge
#     has_reverse = False
#     if G.has_edge(v_node, u_node):
#         edge_data_rev = G[v_node][u_node].copy()
#         G.remove_edge(v_node, u_node)
#         has_reverse = True
...
#     output_filename = f"Setup 3 {road_name} Flows.csv"
...
#     if has_reverse:
#         G.add_edge(v_node, u_node, **edge_data_rev)